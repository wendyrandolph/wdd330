...
let clicked1 = document.getElementById("dice1");
let clicked2 = document.getElementById("dice2");
let clicked3 = document.getElementById("dice3");
let clicked4 = document.getElementById("dice4");
let clicked5 = document.getElementById("dice5");
let clicked6 = document.getElementById("dice6");
let yesBtn = document.getElementById("yesBtn");
let noBtn = document.getElementById("noBtn");
let yesBtn1 = document.getElementById("keptScore");
let showNow = document.getElementById("showNow");
let button = document.getElementById("roll");
let i;
let start = document.getElementById("dice");
...
let reRoll = false;
let list2 = document.querySelectorAll("clicked");
let myCollection2 = Array.from(list2);
...
let rollOnce = document.getElementById("roll");
...
rollOnce.addEventListener("click", function () {
    ...
    if (roll >= 1) {
        ...
        document.getElementById("rollScore").innerHTML = "Score for this roll is = " + " " + 0;
...
function clickedDice() {
    ...
    let myCollection = Array.from(list);
...
function getResults() {
    let diceResults = [0, 0, 0, 0, 0, 0];


    let list = document.querySelectorAll(".click");
    let myCollectionNew = Array.from(list);
    ...
    for (i = 0; i < myCollectionNew.length; i++) {
        ...
        } else if ((diceResults[i] == 3) || (diceResults[i] == 4) || (diceResults[i] == 5)) {
            threeKind = true;
    ...
    //Check for a zonk 
    if (six == false && straight == false && threeKind == false && haveOne == false && haveFive == false) {
        haveZonk = true;
    }
    ...
    if (haveZonk === true) {
        ...
        document.getElementById("runScore").innerHTML = "You lose this rounds points. Roll again.";
...
zonkZone.addEventListener("click", function () {
    ...
    console.log(roundScore + "This is the roundScore result after the Zonk");
    console.log(newScore1 + "This is the newScore1 result after the Zonk");

    dice.removeEventListener("click", quit);
});
...
var quit = dice.addEventListener("click", function () {
    dice = event.target;
...
function getScore() {
    ...
    roundScore = [all6, straight1, triple1, triple2, triple3, triple4, triple5, triple6, trip1, trip2, trip3, trip4, trip5, trip6, score1, score5];
    sum1 = 0;
   ...
   newTotal += (newScore1 + sum1);
    ...
    if (myCollection2.length >= 6) {
        ...
        if (reRoll === true) {
            ...
            document.getElementById("rollScore").innerText = "Score for this round is = " + " " + sum1;
            document.getElementById("roundScore").innerHTML = "Score for this roll is = " + " " + newTotal;
...
yesBtn1.addEventListener("click", function () {
    ...
    button.className = "buttonHide";
    document.getElementById("runScore").innerHTML = " You get to start rolling again ";

    keepScore = [all6, straight1, triple1, triple2, triple3, triple4, triple5, triple6, trip1, trip2, trip3, trip4, trip5, trip6, score1, score5];
    ...
    document.getElementById("total").innerHTML = newScore;

    document.getElementById("rollScore").innerHTML = "Score for this roll is = " + 0;
    document.getElementById("roundScore").innerHTML = "Score for this round is = " + 0;
